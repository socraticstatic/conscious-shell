  ...
  return (
    <>
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="fixed bottom-24 lg:bottom-[4.5rem] right-4 z-[50] font-mono text-[11px] pointer-events-none"
      >
      ...
      <AnimatePresence>
        {integrity === 0 && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="fixed bottom-32 lg:bottom-[7rem] right-4 z-[50] font-mono text-[10px] text-[#ff006e]/80 pointer-events-none"
          >
