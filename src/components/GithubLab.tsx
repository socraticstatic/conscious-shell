...
import GenerativeThumb from './GenerativeThumb';
  ...
  return (
    <section id="lab" className="relative py-20 md:py-28 border-b border-[#1f1c17]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10">
          ...
          <button
            ...
            className={`px-2.5 sm:px-3 py-1 text-[9px] sm:text-[10px] border transition-colors ${
              tag === 'all'
                ...
                : 'border-[#2a2620] text-[#7a6e62] hover:text-[#efe6d4] active:text-[#efe6d4] hover:border-[#3a342c] active:border-[#3a342c]'
            }`}
          >
            ALL · {projects.length}
          </button>
            ...
            >
              ...
              >
                ...
                <div className="relative aspect-[16/10] bg-[#050302]">
                  {view[active.id] === 'live' && active.pages_url ? (
                    <iframe
                    ...
                    <GenerativeThumb
                      seed={`${active.repo_owner}/${active.repo_name}`}
        ...
        {articles.length > 0 && (
          <div className="mt-16 pt-10 border-t border-dashed border-[#1f1c17]">
            <div className="flex items-baseline justify-between mb-6">
              <div className="text-[10px] font-mono text-[#5ec8d8] tracking-[0.35em] uppercase">
                ▸ intercepted transmissions · cross-referenced from /broadcast.log
              </div>
  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] bg-[#050302] overflow-hidden">
        <GenerativeThumb
          seed={`${project.repo_owner}/${project.repo_name}`}
