...
export default function IntelligenceHUD() {
  ...
  return (
    <div className="fixed right-3 sm:right-6 z-[70] font-mono select-none pointer-events-none bottom-[calc(1rem+env(safe-area-inset-bottom,0px))] max-sm:bottom-auto max-sm:top-[6.5rem]">
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute bottom-full right-0 mb-2 w-[min(340px,calc(100vw-2rem))] border bg-black/85 backdrop-blur-md p-3 sm:p-4"
