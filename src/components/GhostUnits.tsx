...
export default function GhostUnits() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-4 z-[92] font-mono text-[11px] text-[#6b6660] pointer-events-none">
        {others > 0 ? (
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[93] font-mono text-[11px] text-[#ff006e] pointer-events-none"
          >
            {toast}
          </motion.div>
        )}
