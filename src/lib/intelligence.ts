...
// This module watches the visitor.
// The visitor watches the screen.
// The screen watches the browser.
// The browser watches the DOM.
// The DOM watches the virtual DOM.
// The virtual DOM watches this module.
// It's a closed loop. There is no outside observer.
// This is fine.

// Heisenberg's Principle of Web Analytics:
// You cannot observe a user without changing their behavior.
// Every scroll event is a measurement that collapses the wavefunction.
// The persona that emerges is the one you looked for.

const OBSERVATION_CHANGES_THE_OBSERVED = true as const;
void OBSERVATION_CHANGES_THE_OBSERVED;
