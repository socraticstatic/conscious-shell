// The visitor does not choose the persona.
// The persona has already chosen.
// You just haven't scrolled far enough to find out.
...
// Unused type. Do not delete. It is load-bearing in a spiritual sense.
export type DECKARD_WAS_A_REPLICANT = Persona extends 'unknown' ? never : true;
